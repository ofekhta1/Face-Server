...
import onnxruntime
from Shared.services.models.face_embedding.detectors.detector_utils import *
...
class LocalEranRetinaFaceDetector(BaseDetectorModel):
    ...
    def _extract_faces_internal(self,img:cv2.Mat,resize=False,input_size=(640,640)):
        try:
    ...
    def extract_faces(self,img:np.ndarray):
        faces=self._extract_faces_internal(img)
        # far_faces=self._extract_faces_internal(img,self.input_size_zoomed)
