...
class FaceEmbedding:
    def __init__(self,name:str,box:list[int],embedding:np.ndarray,quality:float=1,landmarks:list[list[float]]=[],gender:str="",age:int=-1,id:str=None,is_dup=False):
        self.id=id # Set as string to ensure compatibility with uuid
        self.name=name
