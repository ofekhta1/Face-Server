...
from Shared.services.models.face_embedding.quality import BaseQualityModel
import numpy as np
...
class TritonFaceExtractor:
    ...
    def extract_faces(self,filename: str, model: BaseDetectorModel,img=None,quality_type="face_size_quality"):
        if img is None:
